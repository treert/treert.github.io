 ...
 *   - **马要有口鼻和耳朵**。原来只是个圆头的团块，改成朝左的侧影：
 *     口鼻在前、额上一只尖耳、颈后连着鬃，再加一颗墨色眼睛（`chess-piece-ink`）。
...
const PIECE_ART = {
  ...
  2: // 马（朝左的马头：长口鼻在前、额上一只尖耳、颈后先鼓出一撮鬃再收下去）
    '<path d="M32 78C29 62 27 52 24 48 16 44 14 38 19 32 24 28 31 24 39 19'
    + 'L39 6 51 15 57 16C65 22 69 32 70 44 72 56 73 68 74 78Z"/>'
    + '<circle class="chess-piece-ink" cx="35" cy="30" r="3"/>'
    + '<rect x="26" y="78" width="52" height="13" rx="4"/>',
